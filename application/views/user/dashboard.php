...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top" style="font-family: helvetica; color: #ffffff">Aplikasi Penyelarasan Kondisi Perusahaan</a>
    ...
    <header class="masthead">
      <div class="container">
        <div class="intro-text">
          <div class="intro-heading text-uppercase">Selamat datang di aplikasi SPIS !</div>
          <div class="intro-lead-in">Klik tombol dibawah untuk mencoba</div>
